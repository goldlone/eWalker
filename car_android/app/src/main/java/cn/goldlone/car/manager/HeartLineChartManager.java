package cn.goldlone.car.manager;
...
/**
 *
 * @author : Created by CN on 2018/6/10 17:45
 */
public class HeartLineChartManager {
    ...
    //一条曲线
    public HeartLineChartManager(LineChart mLineChart, String name, int color) {
    ...
    //多条曲线
    public HeartLineChartManager(LineChart mLineChart, List<String> names, List<Integer> colors) {
        this.lineChart = mLineChart;
        leftAxis = lineChart.getAxisLeft();
        rightAxis = lineChart.getAxisRight();
        xAxis = lineChart.getXAxis();
