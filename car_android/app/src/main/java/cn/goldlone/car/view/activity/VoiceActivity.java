...
import cn.goldlone.car.utils.JsonParser;
...
public class VoiceActivity extends BaseActivity implements View.OnClickListener{
    ...
    private void initSpeech() {
        ...
        SpeechUtility.createUtility( this, SpeechConstant.APPID + "=5b322ecd" );
    }
...
//        mTts.setParameter(SpeechConstant. TTS_AUDIO_PATH, "./sdcard/iflytek.pcm" );
     ...
     * @param text
     */
    private void speakTextAfterSpeak(String text) {
        // 1. 创建 SpeechSynthesizer 对象 , 第二个参数： 本地合成时传 InitListener
        SpeechSynthesizer mTts = SpeechSynthesizer.createSynthesizer( this, null);
        // 2.合成参数设置，详见《 MSC Reference Manual》 SpeechSynthesizer 类
        // 设置发音人（更多在线发音人，用户可参见 附录 13.2
...
//        mTts.setParameter(SpeechConstant. TTS_AUDIO_PATH, "./sdcard/iflytek.pcm" );
        // 3.开始合成
        mTts.startSpeaking(text, new MySynthesizerListenerAndSpeak()) ;
    }
...
//                showTip("播放完成 ");
     ...
     *
     */
    class MySynthesizerListenerAndSpeak implements SynthesizerListener {
...
//                showTip("播放完成 ");
    ...
    private void startSpeechDialog() {
        ...
        mDialog.setParameter(SpeechConstant.ACCENT, "mandarin" );// 设置中文方言：普通话
